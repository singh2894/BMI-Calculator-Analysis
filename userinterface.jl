...
set_gtk_property!(male_btn, :halign, GtkAlign.START)
set_gtk_property!(female_btn, :halign, GtkAlign.START)
set_gtk_property!(gender_box, :halign, GtkAlign.START)
...
# --- Parse current inputs and save one row (used when Enter is pressed) ---
...
for e in (age_entry, height_entry, weight_entry)
    ...
    signal_connect(e, "key-release-event") do _...; preview(); false end
    # when pressing Enter, refresh + save to CSV
...
# --- Save one row to user_data.csv in the same folder as this script ---
